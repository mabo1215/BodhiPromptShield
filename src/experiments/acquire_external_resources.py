...
RESOURCES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "access_mode": "public_hf_snapshot",
        "notes": "The repository now pins a reproducible public parquet snapshot for the executed FUNSD OCR rerun.",
    },
    {
        "id": "sroie_dataset",
        "category": "OCR-heavy Dataset",
        ...
        "official_url": "https://huggingface.co/datasets/rajistics/sroie_processed",
        "access_mode": "public_hf_snapshot",
        "alternate_urls": ["https://huggingface.co/datasets/sroie"],
        "notes": "The repository now pins the public rajistics/sroie_processed snapshot for the executed SROIE OCR rerun.",
    },
    {
        "id": "docile_benchmark",
        "category": "OCR-heavy Dataset",
